        ...
        <div class="card card-form">
            <div class="row no-gutters">
                <div class="col-lg-4 card-body">
                    ...
                    <p class="text-muted">Please upload an image or video that represents the event. You can drag and drop your files or click to select them. The first uploaded image will be used as the default poster for the event.</p>
                </div>
