...
@section('content')
    ...
    <div class="container mt-4">
        ...
        <div class="px-4 pt-3">
            ...
            <ul class="timeline">
                @forelse (\App\Models\WalletTransaction::whereIn('wallet_id', auth()->user()->wallets->pluck('id'))->latest()->get() as $transaction)
                    <li class="timeline-item {{ $transaction->amount > 0 ? 'item-green' : 'item-red' }}">
                        ...
                        <div class="timeline-item-body">
                            <p><strong>Wallet:</strong> <span class="badge badge-primary" style="font-size: 1em;">{{ $transaction->wallet->name ?? 'Unknown Wallet' }}</span></p>
